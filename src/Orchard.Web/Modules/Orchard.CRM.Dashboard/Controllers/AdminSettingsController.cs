...
namespace Orchard.CRM.Dashboard.Controllers
{
    [ValidateInput(false), Themed]
    public class AdminSettingsController : Controller, IUpdateModel
    {
        ...
        public ActionResult IndexPOST(string groupInfoId, string returnUrl)
        {
            if (!Services.Authorizer.Authorize(Permissions.ManageSettings, T("Not authorized to manage settings")))
                return new HttpUnauthorizedResult();
